	...
	widget    = {
		{
			{
				{
					markup = '<span color="#020127">Volume</span>',
					widget = wibox.widget.textbox,
					font   = 'Iosevka Bold 32',
				},
				{
					id     = "percent",
					text   = '50%',
...
function update_volume_popup()
	volume_popup.visible = true

	awful.spawn.easy_async_with_shell([[awk -F"[][]" '/Left:/ { print $2 }' <(amixer sget Master)]],
		function(stdout)
			volume_popup.widget:get_children_by_id("percent")[1]:set_text(stdout:gsub("\n", ""))
		end)
	...
	table.insert(timers, gears.timer.start_new(1, function()
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "Print",
		function()
			awful.spawn("maim /home/remy/Pictures/" .. os.date("%F-%R:%S") .. ".png")
			naughty.notify({ title = "Screenshot saved to /home/remy/Pictures/" .. os.date("%F-%R:%S") .. ".png" })
		end,
	...
	awful.key({ modkey }, "r", function() awful.spawn("rofi -show drun") end,
		{ description = "search programs", group = "launcher" }),
